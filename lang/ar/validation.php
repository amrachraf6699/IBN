...
return [
    ...
    */
    ...
    'only_one_allowed' => 'يمكنك فقط استخدام حقل واحد.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | يتم استخدام سطور اللغة التالية لتبديل نائب السمة الخاص بنا
    | بشيء أكثر سهولة للقراءة مثل "عنوان البريد الإلكتروني" بدلاً
    | من "email". هذا يساعدنا ببساطة على جعل رسالتنا أكثر تعبيرًا.
    |
    */
