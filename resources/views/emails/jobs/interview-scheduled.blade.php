...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <h2 style="text-align: center;">Your Interview Has Been <span style="color:#ffc107;">Scheduled</span></h2>
            <p>Hello <strong>{{ $application->email }}</strong>,</p>
            <p>We’re excited to let you know that your interview has been officially scheduled for the position:</p>
            ...
            <p><strong>Interview Date & Time:</strong> {{ $application->interview_date->format('F j, Y, g:i A') }}</p>
            <p><strong>Interview Mode:</strong> {{ ucfirst($DBjob->interview_type) }}</p>
            <p style="text-align: center;">
                <a href="{{ route('check.invite' ,$application->uuid) }}" class="btn-primary">View Interview Details</a>
            </p>
            <p style="margin-top: 20px;">Best of luck for your interview!</p>
