...
<head>
    ...
    <style>
        ...
        .btn-primary { display: inline-block; padding: 12px 25px; background-color: #007bff; color: #fff !important; text-decoration: none; border-radius: 5px; margin-top: 20px; }
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <h2 style="text-align: center;">Thank You for Your interview</h2>
            <p>Hello <strong>{{ $application->email }}</strong>,</p>
            <p>We are pleased to have a meeting with you for the position:</p>
            ...
            <p>Please check the details and confirm your availability for the interview.</p>
