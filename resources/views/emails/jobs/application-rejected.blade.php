...
<head>
    <meta charset="UTF-8">
    <title>Application Rejected - {{ config('app.name') }}</title>
    ...
    <style>
        ...
        .btn-primary { display: inline-block; padding: 12px 25px; background-color: #dc3545; color: #fff !important; text-decoration: none; border-radius: 5px; margin-top: 20px; }
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <h2 style="text-align: center;">Your Application has been <span style="color:#dc3545;">Rejected</span></h2>
            <p>Hello <strong>{{ $application->email }}</strong>,</p>
            <p>We regret to inform you that your application for:</p>
            ...
            <p>After careful consideration, we have decided not to proceed with your application at this time. We wish you the best of luck in your job search.</p>
            <p style="text-align: center;">
                <a href="{{ route('check.invite' ,$application->uuid) }}" class="btn-primary">View Other Jobs</a>
            </p>
