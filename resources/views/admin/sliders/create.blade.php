  ...
  <div class="card xl:col-span-2">
    <div class="card-body flex flex-col p-6">
      ...
      <div class="card-text h-full ">
        <form class="space-y-8" enctype="multipart/form-data" method="POST" action="{{ route('admin.sliders.store') }}">
          @csrf
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
              ...
              <div class="input-area">
                ...
                >
                  <option value="left" {{ old('text_horizontally') == 'left' ? 'selected' : '' }}>Left</option>
                  <option value="center" {{ old('text_horizontally') == 'center' ? 'selected' : '' }}>Center</option>
                  <option value="right" {{ old('text_horizontally') == 'right' ? 'selected' : '' }}>Right</option>
                </select>
              ...
              <div class="input-area">
                ...
                >
                  <option value="top" {{ old('text_vertically') == 'top' ? 'selected' : '' }}>Top</option>
                  <option value="center" {{ old('text_vertically') == 'center' ? 'selected' : '' }}>Center</option>
                  <option value="bottom" {{ old('text_vertically') == 'bottom' ? 'selected' : '' }}>Bottom</option>
                </select>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
              ...
              <div class="input-area">
                ...
                >
                  <option value="left" {{ old('button_horizontally') == 'left' ? 'selected' : '' }}>Left</option>
                  <option value="center" {{ old('button_horizontally') == 'center' ? 'selected' : '' }}>Center</option>
                  <option value="right" {{ old('button_horizontally') == 'right' ? 'selected' : '' }}>Right</option>
                </select>
              ...
              <div class="input-area">
                ...
                >
                  <option value="top" {{ old('button_vertically') == 'top' ? 'selected' : '' }}>Top</option>
                  <option value="center" {{ old('button_vertically') == 'center' ? 'selected' : '' }}>Center</option>
                  <option value="bottom" {{ old('button_vertically') == 'bottom' ? 'selected' : '' }}>Bottom</option>
                </select>
