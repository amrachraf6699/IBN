                ...
                <div class="text-center">
                    ...
                    <div class="relative mx-auto w-64 h-64 mb-8">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <span class="text-9xl font-bold text-primary opacity-20">404</span>
                        </div>
                        <div class="absolute inset-0 flex items-center justify-center">
                    ...
                    <!-- Error Message -->
                    <h1 class="text-4xl font-bold text-dark mb-4">{{ __('frontend.page_not_found') }}</h1>
                    <p class="text-xl text-gray-600 mb-8">{{ __('frontend.page_not_found_message') }}</p>
