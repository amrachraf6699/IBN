                ...
                <div class="card-text h-full space-y-4">
                    <div class="input-area">
                        <div class="relative">
                            ...
                            <input type="text" class="form-control" placeholder="{{ __('dashboard.title') }}" name="title[ar]" id="title_ar" value="{{ old('title.ar') }}" required>
                        </div>
                        @error('title.ar')
                    ...
                    <div class="input-area">
                        <div class="relative">
                            ...
                            <input type="text" class="form-control" placeholder="{{ __('dashboard.title') }}" name="title[en]" id="title_en" value="{{ old('title.en') }}" required>
                        </div>
                        @error('title.en')
                            <span class="text-danger text-sm mt-1">{{ $message }}</span>
                        @enderror
