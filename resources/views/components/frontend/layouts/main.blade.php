...
<body class="font-sans text-dark">
    ...
    <header id="header" class="fixed w-full top-0 left-0 z-50 transition-all duration-300 bg-white shadow-md rounded-b-3xl md:rounded-b-full">
        <div class="container mx-auto px-4 py-3">
            <div class="flex items-center justify-between">
                ...
                <nav class="hidden md:flex items-center space-x-8 rtl:space-x-reverse">
                    <a href="{{ route('home') }}"
                        class="text-dark hover:text-primary transition-colors duration-300 relative group {{ request()->routeIs('home') ? 'text-primary' : '' }}">
                        {{ __('frontend.home') }}
                        <span
                            class="absolute bottom-0 left-0 rtl:left-auto rtl:right-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
                    </a>
                    <a href="{{ route('about_us') }}"
                        class="text-dark hover:text-primary transition-colors duration-300 relative group {{ request()->routeIs('about_us') ? 'text-primary' : '' }}">
                        {{ __('frontend.about_us') }}
                        <span
                            class="absolute bottom-0 left-0 rtl:left-auto rtl:right-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
                    </a>
                    <a href="{{ route('services') }}"
                        class="text-dark hover:text-primary transition-colors duration-300 relative group {{ request()->routeIs('services') ? 'text-primary' : '' }}">
                        {{ __('frontend.services') }}
                        <span
                            class="absolute bottom-0 left-0 rtl:left-auto rtl:right-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
                    </a>
                    <a href="{{ route('partners') }}"
                        class="text-dark hover:text-primary transition-colors duration-300 relative group {{ request()->routeIs('partners') ? 'text-primary' : '' }}">
                        {{ __('frontend.partners') }}
                        <span
                            class="absolute bottom-0 left-0 rtl:left-auto rtl:right-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
                    </a>
                    <a href="{{ route('jobs') }}"
                        class="text-dark hover:text-primary transition-colors duration-300 relative group {{ request()->routeIs('jobs') ? 'text-primary' : '' }}">
                        {{ __('frontend.jobs') }}
                        <span
                            class="absolute bottom-0 left-0 rtl:left-auto rtl:right-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
                    </a>
                    <a href="{{ route('our_team') }}"
                        class="text-dark hover:text-primary transition-colors duration-300 relative group {{ request()->routeIs('our_team') ? 'text-primary' : '' }}">
                    ...
                    <a href={{ route('lang.switch', app()->getLocale() == 'ar' ? 'en' : 'ar') }}
                        class="text-dark hover:text-primary transition-colors duration-300 relative group {{ request()->routeIs('lang.switch') ? 'text-primary' : '' }}">
                        <span
                            class="absolute bottom-0 left-0 rtl:left-auto rtl:right-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
                        <button class="flex items-center text-dark hover:text-primary transition-colors duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1 rtl:mr-0 rtl:ml-1" fill="none"
                ...
                <div class="md:block">
                    <a href="{{ route('contact_us') }}"
                        class="btn-contact px-6 py-2 bg-primary text-white rounded-full hover:bg-opacity-90 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white shadow-lg border-t border-gray-100">
            <div class="container mx-auto px-4 py-3 flex flex-col space-y-4">
                <a href="{{ route('home') }}"
                    class="text-dark hover:text-primary transition-colors duration-300 py-2 border-b border-gray-100">{{ __('frontend.home') }}</a>
                <a href="{{ route('about_us') }}"
                    class="text-dark hover:text-primary transition-colors duration-300 py-2 border-b border-gray-100">{{ __('frontend.about_us') }}</a>
                <a href="{{ route('services') }}"
                    class="text-dark hover:text-primary transition-colors duration-300 py-2 border-b border-gray-100">{{ __('frontend.services') }}</a>
                <a href="{{ route('partners') }}"
                    class="text-dark hover:text-primary transition-colors duration-300 py-2 border-b border-gray-100">{{ __('frontend.partners') }}</a>
                <a href="{{ route('jobs') }}"
                    class="text-dark hover:text-primary transition-colors duration-300 py-2 border-b border-gray-100">{{ __('frontend.jobs') }}</a>
                <a href="{{ route('our_team') }}"
                    class="text-dark hover:text-primary transition-colors duration-300 py-2 border-b border-gray-100">{{ __('frontend.our_team') }}</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
                ...
                <div>
                    ...
                    <div class="grid grid-flow-col auto-cols-max gap-6 justify-center">
                        <a href="{{ $socialLinks['facebook'] }}" target="__blank"
                        ...
                        <a href="{{ $socialLinks['twitter'] }}" target="__blank"
                            class="text-white hover:text-primary transition-colors duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="{{ $socialLinks['instagram'] }}" target="__blank"
                            class="text-white hover:text-primary transition-colors duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="{{ $socialLinks['linkedin'] }}" target="__blank"
                            class="text-white hover:text-primary transition-colors duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
                ...
                <div class="location-section">
                    ...
                    <div class="relative group">
                        <div
                            class="absolute inset-0 bg-gradient-to-br from-primary/20 to-transparent rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                        </div>

                        <!-- Map Frame -->
                        <div
                            class="relative bg-white/5 backdrop-blur-sm rounded-xl p-2 border border-white/10 shadow-2xl">
                            <div class="w-full h-48 rounded-lg overflow-hidden relative">
                                ...
                                <iframe src="{{ $socialLinks['location'] }}" width="100%" height="100%"
                                    style="border:0; filter: grayscale(30%) contrast(1.1);" allowfullscreen=""
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="{{ route('home') }}"
                                class="text-light/80 hover:text-primary transition-colors duration-300 flex items-center justify-center hover:translate-x-1 transform">{{ __('frontend.home') }}</a>
                        </li>
                        <li><a href="{{ route('services') }}"
                                class="text-light/80 hover:text-primary transition-colors duration-300 flex items-center justify-center hover:translate-x-1 transform">{{ __('frontend.services') }}</a>
                        </li>
                        <li><a href="{{ route('partners') }}"
                                class="text-light/80 hover:text-primary transition-colors duration-300 flex items-center justify-center hover:translate-x-1 transform">{{ __('frontend.partners') }}</a>
                        </li>
                        <li><a href="{{ route('jobs') }}"
                                class="text-light/80 hover:text-primary transition-colors duration-300 flex items-center justify-center hover:translate-x-1 transform">{{ __('frontend.jobs') }}</a>
                        </li>
                        <li><a href="{{ route('our_team') }}"
                                class="text-light/80 hover:text-primary transition-colors duration-300 flex items-center justify-center hover:translate-x-1 transform">{{ __('frontend.our_team') }}</a>
                        </li>
                        <li><a href="{{ route('about_us') }}"
                                class="text-light/80 hover:text-primary transition-colors duration-300 flex items-center justify-center hover:translate-x-1 transform">{{ __('frontend.about_us') }}</a>
                        </li>
                        <li><a href="{{ route('contact_us') }}"
                                class="text-light/80 hover:text-primary transition-colors duration-300 flex items-center justify-center hover:translate-x-1 transform">{{ __('frontend.contact_us') }}</a>
                        </li>
                    </ul>
                </div>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-D3BG1KZ4SK"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'G-D3BG1KZ4SK');
    </script>

    <!-- Back to Top Button -->
    <button id="back-to-top"
        class="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-primary hover:bg-opacity-90 text-white p-3 rounded-full shadow-lg transition-all duration-300 opacity-0 invisible z-50">
