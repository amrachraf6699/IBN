<a href="{{ route('lang.switch' , app()->getLocale() == 'ar' ? 'en' : 'ar') }}" id="logo-link" class="z-10 fixed bottom-2 right-2 bg-primary text-white p-3 rounded-full shadow-lg hover:scale-105 transition-transform duration-300 w-12 h-12 flex items-center justify-center">
    <svg id="logo-icon"  xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 24 24">
